...
var balance_;
var minPurchase_ = 5000000000000000;
var maxPurchase_ = 2000000000000000000;
...
const MyComponent = () => {
    ...
    let tokenData = {
        "id": "1",
        "token": "0xe1F8787b35f76C7C138c8330BE86ada000006c68",
        "presaleContract": "0x51bFFda3da9bd351DF69d7e06b2a389822FF3d0f",
        "contractABI": "",
        "tokenIconURL": "/mas-k.png",
        "tokenName": "MARS",
        "tokenSymbol": "MRSC",
    ...
    //             //returns no. of tokens for each bnb
    ...
    useEffect(() => {
        ...
        document.getElementById("presale-status").innerHTML = tokenData.status;
        document.getElementById('hard-cap').innerHTML = tokenData.hardCap;
    })
    ...
    function validateExchangeAmount(e) {
        ...
        if (address != null) {
            if (value < walletBalance) {
                ...
                document.getElementById("buy-button").style.boxShadow = "none"
                document.getElementById("buy-button").style.cursor = "not-allowed"
                document.getElementById("buy-button").innerHTML = "INSUFFICIENT BALANCE"
                ...
                document.getElementById("buy-button").style.boxShadow = "none"
                document.getElementById("buy-button").style.cursor = "not-allowed"
                document.getElementById("buy-button").innerHTML = "INVALID AMOUNT"
            ...
            if (valid && (walletBalance > minPurchase)) {
                ...
                document.getElementById("buy-button").style.background = "rgb(32, 133, 26)"
                document.getElementById("buy-button").style.boxShadow = "0px 0px 5px rgb(32, 133, 26)"
            ...
            document.getElementById("buy-button").style.boxShadow = "none"
            document.getElementById("buy-button").style.cursor = "not-allowed"
            document.getElementById("buy-button").innerHTML = "CONNECT WALLET"
        }
        ...
        <>
            <section className={styles.cover}>
                ...
                <div className={styles.tokenPresaleContainer}>
                    <div className={styles.tokenPresaleContainerInner} id="presale-container">
                        <div className={styles.cardHeader}>
                            <div className={styles.logoBlock}>
                                <img src={tokenImageUrl_} alt="marscoin" className={styles.tokenImagePrime} />
                            </div>
                        ...
                        {/* <div className={styles.currencyDrop}>
                                <div className={styles.currencyDropItem} id="bnb">
                                    <img alt="currency" src="/bnb.png"/><h3>BNB</h3>
                                </div>
                                <div className={styles.currencyDropItem} id="usdt">
                                    <img alt="currency" src="/usdt.png"/><h3>USDT</h3>
                                </div>
                                <div className={styles.currencyDropItem} id="busd">
                                    <img alt="currency" src="/busd.png"/><h3>BUSD</h3>
                                </div>
                            ...
                            <small className={styles.balanceText}>Your Balance: <small id="balance-text"></small> BNB</small>
                    ...
                    <div className={styles.brandText}><Link href="https://www.mars.com"><a target="_blank" rel="noreferrer" id="host">Powered by MARS</a></Link></div>
                ...
                <div className={styles.textSection}>
                    ...
                    <h2 className={styles.header}>MARS Presale - Live</h2>
                    <h3 className={styles.header2}>OUR PASSSION FOR CIRCULAR ECONOMY & ZERO WASTE</h3>
                    <h4 className={styles.tag}>
                    MARS offers innovative end-to end solutions that work in ASEAN. We solve environmental problems caused by waste, make the transition to clean energy affordable and strive to lead the resource revolution in ASEAN and beyond.
                    
                    </h4>

                    <div className={styles.actionWrapper}>
                        <Link href="#whitepaper"><a className={styles.actionBtn}>How to Buy?</a></Link>
